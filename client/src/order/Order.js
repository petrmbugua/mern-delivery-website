        ...
        <Grid item xs={7} sm={7}>
          <Card className={classes.innerCardItems}>
                    ...
                    <div className={classes.details}>
                      <CardContent className={classes.content}>
                        ...
                        <Typography
                          ...
                          color='primary'
                        >
                          Kes. {item.product.price} x {item.quantity}
                        </Typography>
            ...
            <div className={classes.checkout}>
              <span className={classes.total}>Total: Kes. {getTotal()}</span>
            </div>
          </Card>
        </Grid>
        <Grid item xs={5} sm={5}>
          <Card className={classes.innerCard}>
            ...
            <Typography
              ...
              color='primary'
            >
              <strong>{order.pickup_address.pickup_name}</strong>
            </Typography>
            <br />
            <Typography
              type='subheading'
            ...
            >
              ...
              You can track the status of your ordered items on this page.
            </Typography>
          </Card>
        </Grid>
      </Grid>
